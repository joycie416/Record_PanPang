...
const Player = async ({ id, token, youtubeURL }: playerProps) => {
  ...
  return (
    <div className="w-[600px] p-4 border-[1px] rounded-md flex flex-row border-gray-300 mb-5">
      ...
      <div className="ml-4">
        ...
        <div className="flex flex-row gap-x-3 text-sm">
          ...
          <p className="overflow-ellipsis overflow-hidden w-[250px] whitespace-nowrap">{music.album.name}</p>
